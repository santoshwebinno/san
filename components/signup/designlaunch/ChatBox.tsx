...
export default function ChatBox({ colors }: any) {

    return (
      <div
        className="w-[90%] h-[75%] rounded-lg p-4 relative shadow-lg bg-[#EAEAEA] text-xs"
       
      >
        <div className="absolute bottom-2 right-2 rounded-full p-2 bg-purple-600 cursor-pointer "  style={{ backgroundColor: colors.buttoncolor }}>
          {/* Chat bubble icon */}
          <div
        ...
        <div className="mb-4 mx-auto p-3 rounded-lg shadow-xl"  style={{ backgroundColor: colors.background }}>
          {/* Chat message bubbles */}
          <div className="flex items-center mb-2">
            <div className="rounded-full  flex items-center justify-center text-white">
            <Image src="/signup/chaticon.svg" alt="User Avatar" height={32} width={32} />
            </div>
            <div className="ml-2 p-2 bg-gray-200 rounded-lg" style={{ backgroundColor: colors.primary }}>
              Ready for the Generative AI revolution?
            </div>
          </div>
          <div className="flex items-center mb-2">
            <div className="ml-auto p-2 bg-purple-500 text-white rounded-lg"style={{ backgroundColor: colors.secondary }}>
              Yes
            </div>
          ...
          <div className="rounded-full  flex items-center justify-center text-white">
            ...
            <div className="ml-2 p-2 bg-gray-200 rounded-lg" style={{ backgroundColor: colors.primary }}>Here we go!</div>
          </div>
    ...
    >
      ...
      />
        ...
        <div className="items-center justify-center my-auto gap-1 flex text-xs text-gray-400 mt-2 text-center p-1">Powered by <Image src={'signup/chatnorglogo.svg'} width={53} height={14} alt={'Norg logo'} className='pt-2'></Image></div>
        </div>
